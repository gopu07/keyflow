...
class CompletedStats extends React.Component<IProps, {}> {
    ...
    public getTimeString(): string {
        ...
        const durationSeconds = Math.round((new Date(last.timestamp).getTime() - new Date(first.timestamp).getTime()) / 1000);
        ...
        return (
            <div className="completed-stats-container">
                ...
                <div className="completed-actions">
                    <button className="restart-button" onClick={this.props.onRestart}>
                        <svg className="restart-icon" viewBox="0 0 24 24" width="18" height="18">
